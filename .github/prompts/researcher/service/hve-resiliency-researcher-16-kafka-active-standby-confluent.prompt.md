...
Assess only application code and configuration that produces to or consumes from Kafka under a user-confirmed Confluent active-standby scenario. Do not assess, redesign, recommend, configure, or provide examples for Confluent provisioning or operations. Do not provide remediation, implementation guidance, configuration examples, or a planning handoff.
