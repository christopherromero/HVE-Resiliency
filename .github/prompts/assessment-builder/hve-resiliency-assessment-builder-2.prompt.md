...
* `Microsoft Assessment/{serviceName}-Code-Level-Resiliency-Assessment.md` - read the final 200 lines only. Confirm the last finding block ends with `---` on its own line.
  * If complete: proceed.
