...
description: "Autonomous orchestrator that runs the HVE resiliency planning pipeline (Phases 4-5) by dispatching the planner prompts in order, producing the executive report, developer guide, and the final Code-Level Resiliency Assessment report"
agents:
  - Researcher Subagent
tools:
  - agent
